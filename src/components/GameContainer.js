...
const GameContainer = () => {
    ...
    const renderLives = () => {
        ...
        for (let i = 0; i < lives; i++) {
            hearts.push(
                <svg key={i} width="20" height="20" viewBox="0 0 20 20" style={{ marginLeft: '5px' }}>
                    <path d="M10 17l-1.5-1.4C3.8 11.4 1 8.1 1 4.5 1 2 3 0 5.5 0S10 2 10 4.5c0 0 0 0 10-4.5S19 0 19 2c2.5 0 4.5 2 4.5 4.5 0 3.6-2.8 6.9-7.5 11.1L10 17z" fill="#ff6666"/>
                </svg>
            );
        }
        return hearts;
    ...
    return (
        <div className="game-container">
            <div className="game-info">
                <div className="score">タイム: <span>{gameTime}秒</span></div>
                <div className="lives">ライフ <span>{renderLives()}</span></div>
            </div>
